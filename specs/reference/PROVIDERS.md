...
each choice. Checked 2026-08-15; quota and pricing facts drift — re-verify
...
| --- | --- | --- | --- | --- |
| QWeather (和风天气) | Yes | API key (`?key=`) or JWT (Ed25519, ≤ 24 h `exp`) | 50k req/month (¥0 tier, Weather group) | **Primary** |
...
Sources: [QWeather pricing](https://dev.qweather.com/en/docs/finance/pricing/),
